 ...
 */
//uthan_load_default_hooks
function uthan_load_default_hooks() {

	$config = uthan_WSH()->config( 'default' );
...
/**
 * [uthan_main_header_area description]
 *
 * @return [type] [description]
 */

//uthan_main_header_area
function uthan_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		uthan_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		uthan_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		uthan_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		uthan_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		uthan_template_load( 'templates/header/header_v5.php' );
	} else {
		uthan_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [uthan_main_footer_area description]
 *
 * @return [type] [description]
 */
//uthan_main_footer_area
function uthan_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		uthan_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		uthan_template_load( 'templates/footer/footer_v2.php' );
	} else {
		uthan_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [uthan_sidebar description]
 *
 * @return [type] [description]
 */
//uthan_sidebar
function uthan_sidebar( $data ) {

	uthan_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [uthan_banner description]
 *
 * @return [type] [description]
 */
//uthan_banner
function uthan_banner( $data ) {

	uthan_template_load( 'templates/banner/banner.php', compact( 'data' ) );
