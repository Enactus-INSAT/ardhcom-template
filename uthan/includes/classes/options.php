...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = 'uthan' . '_options';
	...
	private $page_slug = 'uthan' . '_options';
	...
	private $docs_link = 'https://docs.tonatheme.com';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'UTHAN Options', 'uthan' );
		$this->page_title = esc_html__( 'UTHAN Options', 'uthan' );
	...
	function args() {
		...
		$args['share_icons'][] = array(
			'url'   => 'https://www.pinterest.com/tonatheme_/',
			'title' => 'Visit us on Pinterest',
			'icon'  => 'el el-pinterest',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://www.facebook.com/people/@/tonatheme',
			'title' => 'Like us on Facebook',
			'icon'  => 'el el-facebook',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://twitter.com/tonatheme',
			'title' => 'Follow us on Twitter',
			'icon'  => 'el el-twitter',
		);
		$args['share_icons'][] = array(
			'url'   => 'https://www.linkedin.com/company/tonatheme-web-arcade',
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'uthan' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'uthan' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'uthan' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'uthan' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'uthan' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'uthan_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "uthan_redux_sections_{$key}", $options );
