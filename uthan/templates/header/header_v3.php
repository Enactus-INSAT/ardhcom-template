                        ...
                        <div class="right-column pull-right">
                            <ul class="info-box clearfix">
                                ...
                                <li>
                                    ...
                                    <p><?php echo wp_kses( $options->get( 'email_title_v1'), $allowed_html ); ?> <a href="tel:<?php echo wp_kses( $options->get( 'email_link_v1'), $allowed_html ); ?>"><?php echo wp_kses( $options->get( 'email_v1'), $allowed_html ); ?></a></p>
                                </li>
