...
$footer_shape_3    = uthan_set( $footer_shape_3, 'url', UTHAN_URI . 'assets/images/shape/footer-shape-1.png' );

$footer_shape_4    = $options->get( 'footer_shape_four' );
$footer_shape_4    = uthan_set( $footer_shape_4, 'url', UTHAN_URI . 'assets/images/shape/footer-shape-2.png' );
                    ...
                    <div class="left pull-left">
                        <div class="subscribe-social-links">
                            ...
                            <?php
								...
								?>
								<li><a href="<?php echo esc_url(uthan_set( $header_social_icons, 'url' )); ?>" style="background-color:<?php echo esc_attr(uthan_set( $header_social_icons, 'background' )); ?>; color: <?php echo esc_attr(uthan_set( $header_social_icons, 'color' )); ?>"><i class="fa <?php echo esc_attr( uthan_set( $header_social_icons, 'icon' ) ); ?>"></i></a></li>
							<?php endforeach; ?>
                            </ul>
                        </div>    
                    </div>
            ...
            <div class="container">
                <div class="outer-box">
                    <div class="copyright-text text-center">
                        <p><?php echo wp_kses( $options->get( 'copyright_text2', '&copy; Copyright 2021 by <a href="#">uthan</a>' ), $allowed_html ); ?></p>
                    </div>
                </div>    
            </div>    
        </div>
