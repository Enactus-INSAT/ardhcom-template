...
$search_image    = uthan_set( $search_image, 'url', UTHAN_URI . 'assets/images/search.png' );
...
<div class="container">		 
		<div class="row clearfix">			
			<div class="col-md-5 col-sm-12 col-xs-12">
				...
				<img src="<?php echo esc_url($search_image);?>	" alt="<?php esc_attr_e('Image', 'uthan');?>">
				
				<?php else : ?>
				<img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/search.png');?>" alt="<?php esc_attr_e('Image', 'uthan');?>">
				<?php endif; ?>	  
		...
		<!--  Back to Home -->
			...
			<div class="error_btn1 btn-box wow fadeInUp animated" data-wow-delay="300ms">
				...
				<div class="btn-box">
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="btn-onexx"><i class="fas fa-home"></i><?php esc_html_e( 'Back To Home', 'uthan' ); ?></a>
