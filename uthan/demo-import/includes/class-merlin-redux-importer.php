...
class Merlin_Redux_Importer {
	...
	public static function import( $import_data ) {
		...
		foreach ( $import_data as $redux_item ) {
			$redux_options_raw_data = uthan_filesystem()->get_contents( $redux_item['file_path'] );
			...
			if ( isset( $redux_framework->args['opt_name'] ) ) {
				...
				Merlin_Logger::get_instance()->debug( __( 'The Redux Framework data was imported' , 'uthan'), $redux_item );
			}
		}
